classdef m_06_alpine1_4p_2s < MARRMoT_model
    ...
    methods
        ...
        function obj = m_06_alpine1_4p_2s(delta_t, theta)
            ...
            obj.Flux_Ea_idx = 4;                                           % Index or indices of fluxes to add to Actual ET
            obj.Flux_Q_idx  = [5 6];                                       % Index or indices of fluxes to add to Streamflow
