...
## 2019/04/04
## This function was modified to utilize a wider search range then the original
## fzero function. Changes on line 165, where values >1000 & <-500 were added.
...
function [x, fval, info, output] = fzero (fun, x0, options = struct ())
  ...
  if (length (x0) > 1)
    ...
    for srch = [-.01 +.025 -.05 +.10 -.25 +.50 -1 +2.5 -5 +10 -50 +100 -500 +1000 -5000 +10000 -50000 +100000]
      b = aa + aa*srch;
      fb = fun (b);
      nfev += 1;
