classdef m_35_mopex5_12p_5s < MARRMoT_model
    ...
    methods
        ...
        function obj = m_35_mopex5_12p_5s(delta_t, theta)
            ...
            obj.Flux_Ea_idx = [5 6 9];                                     % Index or indices of fluxes to add to Actual ET
            obj.Flux_Q_idx  = [12 13];                                     % Index or indices of fluxes to add to Streamflow
