...
filepath = '/home/yifat/MARRMoT/BMI/Config/BMI_testcase_m01_BuffaloRiver_TN_USA';
...
ts = obj_marrmot_m01.get_start_time();
te = obj_marrmot_m01.get_end_time();
tn = te-ts;
% datenum return time as a serial day number with Jan 1, 0000 defined as day 1.

% Run a loop
qsim = NaN.*zeros(tn,1);

while obj_marrmot_m01.get_current_time() <= te
